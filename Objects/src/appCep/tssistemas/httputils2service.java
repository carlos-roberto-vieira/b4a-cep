...
public class httputils2service extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "appCep.tssistemas", "appCep.tssistemas.httputils2service");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "appCep.tssistemas.httputils2service", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public appCep.tssistemas.main _main = null;
public appCep.tssistemas.starter _starter = null;
public static String  _completejob(int _taskid,boolean _success,String _errormessage) throws Exception{
appCep.tssistemas.httpjob _job = null;
...
_job = (appCep.tssistemas.httpjob)(_taskidtojob.Get((Object)(_taskid)));
...
public static String  _submitjob(appCep.tssistemas.httpjob _job) throws Exception{
