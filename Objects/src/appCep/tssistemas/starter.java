...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "appCep.tssistemas", "appCep.tssistemas.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "appCep.tssistemas.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
_rp = new anywheresoftware.b4a.objects.RuntimePermissions();
 //BA.debugLineNum = 12;BA.debugLine="Public ncount As Int  = 0";
_ncount = (int) (0);
